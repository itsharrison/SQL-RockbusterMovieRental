~~~SQL
-- This query lists the top 10 cities with the highest customer counts, their customer counts, the counts of the customers who spent the most, and where they are located in those cites
